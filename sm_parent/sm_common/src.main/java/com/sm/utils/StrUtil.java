...
import com.sm.utils.number.NumberFormat;
...
public final class StrUtil {
	...
	public static boolean isMobileNum(String mobileNum) {
		...
		return mobileNum.matches("^((13[0-9])|(14[4,7])|(15[^4,\\D])|(16[6])|(17[6-8])|(18[0-9])|(19[8,9]))(\\d{8})$");
	}
	...
	public static void main(String[] args) {
		for(int i=1;i<=15;i++) {
			for(int j=1;j<=i;j++) {
				System.out.println(Arrays.asList(getPageArr(i,j)));
			}
		}
	...
	public static String[] getPageArr(int totalPages,int currPage){
		...
		if(totalPages <= 4){
			...
			for (int i = totalPages; i >= totalPages - 1; i--) {
				pageSet.add(i);
			}
	 ...
	 *
	 * @author chenyang
	 * @createDate 2018年7月13日 下午8:19:28
	 */
